...
use CoreBundle\Form\PedidosType;
...
class PedidosController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $pedidos = $em->getRepository('CoreBundle:Pedidos')->findAll();
    ...
    {
        $pedido = new Pedidos();
        $form = $this->createForm('CoreBundle\Form\PedidosType', $pedido);
    ...
    {
        $deleteForm = $this->createDeleteForm($pedido);
        $editForm = $this->createForm('CoreBundle\Form\PedidosType', $pedido);
